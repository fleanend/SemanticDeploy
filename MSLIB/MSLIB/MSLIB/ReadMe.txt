========================================================================
    LIBRERIA STATICA: cenni preliminari sul progetto MSLIB
========================================================================

La creazione guidata applicazione ha creato questo progetto di libreria MSLIB.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione MSLIB.
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato MSLIB.pch e il file dei tipi precompilato StdAfx.obj.
