...
namespace TextToSpeech
{
	...
	void TextToSpeech::testHr(HRESULT hr)
	{
		if (FAILED(hr))
		{
			throw 10;
	...
	char* TextToSpeech::TextToPCM(wchar_t* textToRender, ULONG* bytesRead)
	{
		HRESULT hr = S_OK;
		...
		try
		{
			...
			ULONG sSize = static_cast<ULONG>(stats.cbSize.QuadPart);
